...
public class VoiceConvertManager2 implements VoiceConvertInterface {
    ...
    private VoiceConvertManager2() {

    }

    private static class Singleton {
        private static final VoiceConvertInterface INSTANCE = new VoiceConvertManager2();
    }
