...
//        }
                ...
                try {
                    ...
                    if ("20000".equals(resultCode)) {
                        ...
                        onFault(TYPE_CONTENT_TEXT, VoiceEngraveConstants.ERROR_CODE_FROM_SERVER,
                                "get text list, response code：" + resultCode + ", errorMessage: " + jsonObject.getString("message"));
                    }
                } catch (Exception e) {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    if ("20000".equals(resultCode)) {
                        ...
                        onFault(TYPE_RECORD, VoiceEngraveConstants.ERROR_CODE_FROM_SERVER,
                                "getVoiceMouldId, response code：" + resultCode + ", errorMessage: " + jsonObject.getString("message"));
                    }
                } catch (Exception e) {
    ...
    public static void getMouldList(int page, int limit, String queryId) {
        ...
        ConcurrentHashMap<String, String> headers = getHeaders();
        BakerOkHttpClient.getInstance().enqueue(BakerOkHttpClient.getInstance().createPostRequest(
                NetConstants.URL_GET_MOULD_LIST_INFO, params, headers), new Callback() {
            @Override
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
